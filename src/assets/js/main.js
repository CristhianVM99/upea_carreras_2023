...
(function($) {
   ...
   // scrollTop init    
    ...
    //Gallery 
    $(".loadgallery").slice(0, 3).show();
    if ($(".addgallery:hidden").length != 0) {
      $("#loadmore").show();
    }   
    
    $("#loadmore").on('click', function (e) {
      e.preventDefault();
      $(".loadgallery:hidden").slice(0, 3).slideDown();
      if ($(".loadgallery:hidden").length == 0) {
        $("#loadmore").fadeOut('slow');
      }
    });
