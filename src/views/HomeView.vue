<template>
  ...
  <div class="main-content">
          ...
          <div class="col-lg-7 md-mt-50 pl-45 md-pl-15">
            <div class="sec-title mb-35">
              ...
              <div class="des mb-20">
                ...
                dexercitation ullamco laboris nisi ut aliquip ex ea commodo consequat
              </div>
            ...
            <div class="btn-part wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
              <a class="readon" href="about.html"
                >Start Course <i class="flaticon flaticon-right-arrow"></i>
              </a>
            </div>
          </div>
        </div>
    ...
    <div
      ...
      class="sc-popular-courses courses-style2 gray-bg2 main-home pt-110 pb-110 md-pt-70 md-pb-70"
    >
      <div class="container">
        ...
        <div
          class="btn-part text-center mt-40 md-mt-20 wow fadeInUp"
          data-wow-delay="300ms"
          data-wow-duration="2000ms"
        >
          <a class="readon" href="course.html"
            >View All Course <i class="flaticon flaticon-right-arrow"></i
          ></a>
        </div>
      </div>
    </div>
      ...
      <div class="container position-relative">
        <div class="row align-items-center">
          <div class="col-lg-6 md-mb-50 pr-105 md-pr-15">
            <div class="sec-title mb-35">
              <div class="sub-title position-relative">
                Skills <span class="heading-border-line"></span>
              </div>
              ...
              <div class="sc-skill-bar">
                ...
                <div class="progress">
                  <div class="progress-bar" style="width: 96%; background: #102d42">
              ...
              <div class="sc-skill-bar">
                ...
                <div class="progress">
                  <div class="progress-bar" style="width: 90%; background: #102d42">
              ...
              <div class="sc-skill-bar">
                ...
                <div class="progress">
                  <div class="progress-bar" style="width: 76%; background: #102d42">
              ...
              <div class="sc-skill-bar">
                ...
                <div class="progress">
                  <div class="progress-bar" style="width: 85%; background: #102d42">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 pl-85 md-pl-15">
            <div class="sec-title mb-20">
              <div class="sub-title position-relative">
                Explore Event <span class="heading-border-line"></span>
              </div>
            ...
            <div class="btn-part wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
              <a class="readon" href="contact.html"
                >Explore Event <i class="flaticon flaticon-right-arrow"></i>
              </a>
            </div>
          </div>
        </div>
                    ...
                    <div class="animate-img__in" data-image="src/assets/images/testimonial/4.png">
                      <div class="animate-more">
                        <div class="animate-content">
                          ...
                          <div class="desc">
                            Lorem ipsum dolor sit amet, consectetur sedo adipiscing elit sed.
                            Capitalize on low hanging fruit to identify a ballpark value added to
                            beta test.
                          </div>
